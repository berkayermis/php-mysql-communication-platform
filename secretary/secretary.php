      ...
      <li class="flex-item">
          <div class='container2'> 
           ...
           <div id="idcreate-course" class="modal">
                ...
                <form class="form" method="post" action="secretary.php#course">
                ...
                <button href="secretary.php#course" name="create_course_button" type="submit">Create Course</button>
                </form>
            </div>
...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    ...
    "<td>" . $row['date_time']. "</td>" .
    "<td>" . "<a style='color:rgb(194, 55, 55);' onclick=\"location.href='deletecourse.php?info=$data_id'\">" . "<i class=\"fas fa-trash-alt\">" . "</i>" .  "</a>" . "</td>" . "</tr>";
  }
  echo "</tbody>" . "</table>";
} else {
  echo "0 results";
...
if(isset($_POST['create_course_button'])){
  ...
  $cc_course_instructor_id = $_SESSION['xyz'];
